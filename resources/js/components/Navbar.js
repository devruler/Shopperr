...
export const Navbar = () => {
    ...
    return (
        <>
            <div style={{backgroundColor: "#171919", height:'53px'}}>

                <nav className="navbar navbar-expand-lg navbar-dark fixed-top shadow-sm py-lg-0" style={{backgroundColor: "#171919"}} >
