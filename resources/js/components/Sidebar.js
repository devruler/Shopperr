            ...
            <div className="card rounded-0 border-0 shadow-sm">
                <div className="card-body">
                    ...
                    <div className="border-bottom py-3">
                        <div>
                            {!showOptions.category && <button className="btn btn-light btn-lg w-100 rounded-0" onClick={() => setShowOptions({ ...showOptions, category: true })}>
                                <span>Category</span>
                                <i className="fas fa-angle-down ml-2"></i>
                            </button>}
                            {showOptions.category && <button className="btn btn-light btn-lg w-100 rounded-0" onClick={() => setShowOptions({ ...showOptions, category: false })}>
                                <span>Category</span>
                    ...
                    <div className="border-bottom py-3">
                        <div>
                                {!showOptions.maker && <button className="btn btn-light btn-lg w-100 rounded-0" onClick={() => setShowOptions({ ...showOptions, maker: true })}>
                                    <span>Maker</span>
                                    <i className="fas fa-angle-down ml-2"></i>
                                </button>}
                                {showOptions.maker && <button className="btn btn-light btn-lg w-100 rounded-0" onClick={() => setShowOptions({ ...showOptions, maker: false })}>
                                    <span>Maker</span>
                                    <i className="fas fa-angle-up ml-2"></i>
                                </button>}
                        </div>
                    ...
                    <div className="border-bottom py-3">
                        <div>
                            {!showOptions.model && <button className="btn btn-light btn-lg w-100 rounded-0" onClick={() => setShowOptions({ ...showOptions, model: true })}>
                                <span>Model</span>
                                <i className="fas fa-angle-down ml-2"></i>
                            </button>}
                            {showOptions.model && <button className="btn btn-light btn-lg w-100 rounded-0" onClick={() => setShowOptions({ ...showOptions, model: false })}>
                                <span>Model</span>
                                <i className="fas fa-angle-up ml-2"></i>
                            </button>}
                        </div>
                    ...
                    <div className="py-3">
                        <div>
                            {!showOptions.engine && <button className="btn btn-light btn-lg w-100 rounded-0" onClick={() => setShowOptions({ ...showOptions, engine: true })}>
                                <span>Engine</span>
                                <i className="fas fa-angle-down ml-2"></i>
                            </button>}
                            {showOptions.engine && <button className="btn btn-light btn-lg w-100 rounded-0" onClick={() => setShowOptions({ ...showOptions, engine: false })}>
                                <span>Engine</span>
                                <i className="fas fa-angle-up ml-2"></i>
                            </button>}
                        </div>
